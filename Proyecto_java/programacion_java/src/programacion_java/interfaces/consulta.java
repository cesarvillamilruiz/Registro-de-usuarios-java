...
public class consulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONSULTAR DATOS DE CLIENTES");
        ...
        Direccion.setFont(new java.awt.Font("Comic Sans MS", 0, 11)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(t12)
                                    .addComponent(t13)
                                    .addComponent(t14, javax.swing.GroupLayout.DEFAULT_SIZE, 143, Short.MAX_VALUE)))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btn_consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_consultarActionPerformed
        ...
        try{
            ...
            PreparedStatement pst=cn.prepareStatement("SELECT * FROM cliente11 WHERE identificacion=?");
            pst.setString(1,t9.getText());
            
            rs=pst.executeQuery();
            
            if(rs.next()){
                t15.setText(rs.getString("identificacion"));
                t10.setText(rs.getString("nombre"));
                t11.setText(rs.getString("fecha"));
                t12.setText(rs.getString("telefono"));
                t13.setText(rs.getString("direccion"));
                t14.setText(rs.getString("ciudad"));
                t9.setText(null);
